...
execute as @a[tag=has_weapon] at @s anchored eyes run summon minecraft:slime ^ ^-0.1 ^0.2 {Tags:["hit_detection"], NoAI:1b, NoGravity:1b, Silent:1b, PortalCooldown:1, Team:"hit_detection"}